...
//     const form = e.currentTarget;
//     // Try to get files from stored refs first, then from form
...
//     // Check if files are actually selected by looking at the form inputs
...
//     // Create FormData manually to ensure files are properly included
